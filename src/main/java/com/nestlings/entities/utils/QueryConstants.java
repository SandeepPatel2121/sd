...
public class QueryConstants {
    ...
    public static final String RATINGS_TEXT = "ratingsText";
    public static final String RATINGS_ID = "ratingsId";
    ...
    public static final String APPLICATION_STATUS_ID = "applicationStatusId";
